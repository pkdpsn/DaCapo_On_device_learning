...
class MNIST_CNN(nn.Module):
    def __init__(self, input_shape, hidden_units, output_shape):
        ...
        # 3 Convolutional Blocks, each with one Conv2d layer followed by ReLU
        ...
        # After 3 convolutional layers (without pooling), the size remains the same if padding is used
